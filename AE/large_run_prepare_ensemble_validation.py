...
global_best_params = {'base__hidden_size': 92, 'base__encoding_size': 250, 'base__z_p_dropout': 0.9234988744649322, 'base__lr': 0.000623438837, 'base__num_layers': 2, 
'base__weight_decay': 0.00049754544443277, 'ensemble__lr_low': 0.00012432605981159723, 'ensemble__lr_high': 0.00027772318534326874, 
'ensemble__weight_decay': 0.0008597354444154666, 'ensemble__frequency_step': 5, 'trainer__epochs_base': 40, 'trainer__num_ensemble_models': 16, 'trainer__batch_size':
 256}
...
#SWA
trainer.save_checkpoint(f'{DIR_RESULTS}/{EXPERIMENT_NAME}/AE_base_split_{k}_weights.ckpt')
model = Model.load_from_checkpoint(checkpoint_path=f'{DIR_RESULTS}/{EXPERIMENT_NAME}/AE_base_split_{k}_weights.ckpt', **params)
