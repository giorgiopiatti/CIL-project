...
class DatasetComplete(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        return user, torch.tensor(index)
...
class DatasetValidation(torch.utils.data.Dataset):
    def __init__(self,matrix, matrix_val):
        super().__init__()
        self.matrix = matrix
    ...
    def __getitem__(self, index):
        ...
        return user, user_val, torch.tensor(index)
