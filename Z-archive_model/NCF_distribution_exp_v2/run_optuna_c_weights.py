...
def create_trial_params(trial):
    params = {
        "embedding_size_movie": trial.suggest_int('embedding_size_movie', 2,128), 
        "embedding_size_user": trial.suggest_int('embedding_size_user', 2,128), 
...
def trial_fn(trial):
    ...
    model = Model(**params, loss_use_class_weights=True)
...
if __name__ == "__main__":
    ...
    model = Model(**best_params, loss_use_class_weights=True)
