...
def create_trial_params(trial):
    params = {
        "number_of_factors": trial.suggest_int('number_of_factors', 1,15), 
        "factor_embedding_size": trial.suggest_int('factor_embedding_size', 2,8), 
        "last_factor_size": trial.suggest_int('last_factor_size', 2, 16), 
        "factor_hidden_size": trial.suggest_int('factor_hidden_size', 4,16),
        "last_factor_hidden_size": trial.suggest_int('last_factor_hidden_size', 4,16),
        ...
        # "distance_4_to_5" : trial.suggest_float('distance_4_to_5', 1e-1, 3.5),
