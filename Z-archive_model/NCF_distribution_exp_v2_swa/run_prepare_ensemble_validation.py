...
model = NCFDistribution.load_from_checkpoint(f'{DIR_RESULTS}/NCF_dist_exp_2_embeddings/NCF_dist_exp_2_embeddings_split_{k}_weights.ckpt', **params, **distance_params)
