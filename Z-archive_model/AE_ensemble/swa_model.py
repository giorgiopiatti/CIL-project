...
class SWAModel(pl.LightningModule):
    ...
    def configure_optimizers(self):
        opt = torch.optim.Adam(self.base_model.parameters(), lr= self.lr_low, weight_decay= self.weight_decay)
        return {
            "optimizer": opt,
    ...
    def training_step(self, batch, batch_idx):
        ...
        if (self.trainer.global_step//2 + 1) % self.frequency_step == 0: #End of cycle, need to checkpoint
