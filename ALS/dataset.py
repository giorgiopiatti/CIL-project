...
def save_predictions_from_pandas(res_path, predictions, index_pd):
    """
    Save predictions into csv using `index_pd` as source for user/movie pair
    """
...
def save_predictions(res_path, predictions):
    """
    Save predictions into csv using sampleSubmission.csv as source for user/movie pair
    """
