...
def create_trial_params(trial):
    params = {
        ...
        "num_masked_movies": trial.suggest_int('num_masked_movies', 1, 6)    
    }
...
def trial_fn(trial):
    ...
    num_masked_movies = params['num_masked_movies']
    del params['num_masked_movies']
    model = Model(**params)
...
if __name__ == "__main__":
    ...
    num_masked_movies = best_params['num_masked_movies']
    del best_params['num_masked_movies']
