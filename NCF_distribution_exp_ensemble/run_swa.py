...
EXPERIMENT_NAME = 'NCF_dist_exp_ensemble SWA'
DEBUG = False
...
#model = NCFDistribution.load_from_checkpoint('./epoch=19-step=82740.ckpt', swa=True, **params)
...
trainer = pl.Trainer(
        ...
        callbacks=[
            ...
            StochasticWeightAveraging(swa_epoch_start=6, swa_lrs=0.003, annealing_epochs=5, annealing_strategy='cos')]
        )
