...
import numpy as np
from dataset import extract_users_movies_ratings_lists, save_predictions_from_pandas
...
save_predictions_from_pandas(f'{DIR_RESULTS}/{EXPERIMENT_NAME}/{EXPERIMENT_NAME}_split_{k}_test_results.csv', test_pred, test_pd)
save_predictions_from_pandas(f'{DIR_RESULTS}/{EXPERIMENT_NAME}/{EXPERIMENT_NAME}_split_{k}_val_results.csv', val_pred, val_pd)