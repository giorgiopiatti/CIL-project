...
class NCFDistribution(pl.LightningModule):
    ...
    def forward(self, batch):
        ...
        rating_1_prob = self.pdf_gaussian(-self.distance_0_to_3 -
                                          self.distance_3_to_2 - self.distance_2_to_1, mu, sigma) + 0.01
        rating_2_prob = self.pdf_gaussian(-self.distance_0_to_3 -
                                          self.distance_3_to_2, mu, sigma) + 0.01
        ...
        rating_5_prob = self.pdf_gaussian(
            self.distance_0_to_4 + self.distance_4_to_5, mu, sigma) + 0.01
